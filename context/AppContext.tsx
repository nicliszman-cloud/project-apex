  ...
  const loadRemoteData = useCallback(async () => {
    ...
    try {
      ...
      const [
        ...
        supabase.from('cars').select('id, owner_id, make, model, model_year, engine, transmission, drivetrain, stock_hp, current_hp, category, city, state, cover_url, modifications, created_at').order('created_at', { ascending: false }),
